    ...
    >
      ...
      <div className="relative z-[2] mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-32 sm:py-40">
        ...
        <div className="text-center">
          ...
          {/* Red accent line */}
          <div className="hero-line mx-auto mt-6 h-1.5 w-32 sm:w-48 bg-linear-to-r from-[#c60000] to-[#ff3333] rounded-full origin-left scale-x-0" />
                ...
                <span
                  className={
                    word === "VISION," || word === "CODE"
                      ? "bg-linear-to-r from-[#c60000] via-[#ff3333] to-[#c60000] bg-clip-text text-transparent"
                      : "text-[#F1F4F9]"
                  }
                >
                  {word}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4">
            {[
              ...
              <div
                ...
                } sm:border-r sm:border-white/8 sm:last:border-r-0 ${
                  i < 2 ? "border-b border-white/8 sm:border-b-0" : ""
                }`}
              >
